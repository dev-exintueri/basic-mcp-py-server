...
source_html: https://code.claude.com/docs/en/glossary
title: "Glossary"
category: concept
fetched: 2026-07-25
summary: "Claude Code 용어 정의집. agentic loop, compaction, CLAUDE.md, 훅, 서브에이전트, MCP 등 핵심 개념의 공식 정의. 문서 간 용어를 맞출 때 기준으로 삼는다."
---
