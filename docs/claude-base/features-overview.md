...
source_html: https://code.claude.com/docs/en/features-overview
title: "Extend Claude Code"
category: concept
fetched: 2026-07-25
summary: "CLAUDE.md, Skills, 서브에이전트, 훅, MCP, 플러그인을 각각 언제 써야 하는지 비교하는 개요. MCP가 확장 수단 중 어디에 위치하는지(외부 시스템 연동) 판단 기준을 제공한다."
---
