...
source_html: https://code.claude.com/docs/en/agent-sdk/overview
title: "Agent SDK overview"
category: concept
fetched: 2026-07-25
summary: "Claude Code를 라이브러리로 써서 프로덕션 에이전트를 만드는 Agent SDK 개요. MCP 서버가 SDK 에이전트의 도구 공급원으로 어떻게 들어가는지의 큰 그림."
---
