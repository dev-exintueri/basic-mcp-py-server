...
source_html: https://code.claude.com/docs/en/hooks
title: "Hooks reference"
category: mcp-ops
fetched: 2026-07-25
summary: "훅 이벤트·설정 스키마·JSON 입출력·종료 코드 레퍼런스. PreToolUse/PostToolUse 매처로 MCP 도구(mcp__*)를 가로채는 방법이 포함되어, 서버 호출 전후에 검증·로깅·차단을 붙일 때 참고한다."
---
